...
library(readr)
d_1_28 <- read_csv("C:/Users/windw/Downloads/1-28_2025-08-26.csv")

library(readr)
d_1_5 <- read_csv("C:/Users/windw/Downloads/1-5_2025-08-27.csv")
...
pef2 = select(d_1_28, contains("pm"))
...
newd_1_28 = select(d_1_28, id:pm10)
names (newd_1_28)

#membuat dataset baru untuk subject 1-28 dgn variabel terpilih
newd_1_5 = select(d_1_5, id:pm10)


names(newd_1_28)
class(newd_1_28$time)

#memberikan id kepada observasi > jam 09:00:00
newd_1_28$id_subject  = NA

#memberikan id kepada observasi < jam 09:00:00
newd_1_5$id_subject  = NA

#kode di bawah tidak berhasil
newd_1_28$id_subject [newd_1_28$time > 09:00:00] = "1-28"
newd_1_5$id_subject [newd_1_5$time < 09:00:00] = "1-28"

#memilih berdasarkan range urutan observasi/baris
#1-28
newd_1_28 = slice(newd_1_28, 2160:5737)

#1-28
newd_1_5 = slice(newd_1_5, 1:2159)
#memberikan id kepada observasi < jam 09:00:00
newd_1_5$id_subject  = "1-28"

#menyatukan dua data set dengan jumlah & jenis variable yang sama
newd = rbind(newd_1_28,newd_1_5)

#export ke csv
write.csv(newd,"tugas2.csv")

library(ggplot2)
#menampilkan daftar variabel dari dataset yang akan dikerjakan
names(newd)
ggplot(data = newd , aes(x = time, y = pm1)) +
  geom_point(size=0.5,color="yellow") +
